...
public class MenuPembayaran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setFont(new java.awt.Font("Swis721 BlkCn BT", 0, 30)); // NOI18N
        ...
        jRadioButton2.setFont(new java.awt.Font("Swis721 BlkCn BT", 0, 30)); // NOI18N
        jRadioButton2.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton2.setText("Dana");

        jRadioButton3.setBackground(new java.awt.Color(0, 0, 255));
        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setFont(new java.awt.Font("Swis721 BlkCn BT", 0, 30)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(buttonGroup1.getSelection().isSelected()){
            kursi.CekText(Kursi.KursiText);
        String str = "";
        for(String s : Kursi.NewKursi){
            str+= s +", ";
        }
        jLabel9.setText("Kursi : "+str);
        jLabel11.setText("Harga : Rp "+Double.toString(kursi.totalHarga()));
        jLabel3.setText("Kode booking : "+Integer.toString(kursi.random()));
        JOptionPane.showMessageDialog(null, "Pembayaran telah berhasil!");
